		...
		for (var j = 0; j < oTr.length; j++) {
			...
			oTr[j].onclick = function() {
				...
				parentN.style.position = "relative";
					...
					otriangleSerch.style.top = "23px";
					otriangleSerch.style.left = "-31px";
					otriangleSerch.style.backgroundColor="white";
					// var otriangleSerch2 = document.createElement('div');
					// var otriangleSerch3 = document.createElement('div');
					// otriangleSerch2.style.position ="absolute";
					// otriangleSerch2.style.left = "30px";
					// otriangleSerch2.style.overflow = "hidden";
					// otriangleSerch2.style.width = 0;
					// otriangleSerch2.style.height = 0;
					// otriangleSerch2.style.borderWidth = "10px";
					// otriangleSerch2.style.borderStyle = "solid dashed dashed dashed";
					// otriangleSerch2.style.bottom = "135px";
					// otriangleSerch2.style.borderColor = "transparent transparent black transparent";
					// otriangleSerch3.style.position ="absolute";
					// otriangleSerch3.style.left = "30px";
					// otriangleSerch3.style.overflow = "hidden";
					// otriangleSerch3.style.width = 0;
					// otriangleSerch3.style.height = 0;
					// otriangleSerch3.style.borderWidth = "10px";
					// otriangleSerch3.style.borderStyle = "solid dashed dashed dashed";
					// otriangleSerch3.style.bottom = "135px";
					// otriangleSerch3.style.borderColor = "transparent transparent white transparent";
					// otriangleSerch.appendChild(otriangleSerch2);
					// otriangleSerch.appendChild(otriangleSerch3);
